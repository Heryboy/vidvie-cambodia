...
<html>
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <link href="{{url('lib/AdminLTE/fileman/css/jquery-ui.css')}}" rel="stylesheet">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <footer class="main-footer">
        ...
        <strong>{{FOOTER_TEXT}} <a href="{{ SITE_HTTP_URL}}" target="_blank">{{SITE_NAME}}</a>.</strong> {{FOOTER_TEXT2}} <a href="http://www.khmergecko.com">Khmer Gecko</a>
      </footer>
