        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-info">
              ...
              {!! Form::open(['url' => 'admin/user_mgr/user','class'=>'form-horizontal']) !!}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        ...
                        <!-- <input type="file" name="img_service" class="form-controller"> -->
                        ...
                        <div style="position:relative;display:none;">
                              <!--e-logo-->
                              <div class="e-logo">
                                  <img height="100" src="{{url('/images/icon/no-image.png')}}" id="l" /> 
                                  <a class="file"><span>Change Image</span>
                                    <!-- <input type="file" name="thumbnail" id="thumbnail" /> -->
                                    {!! Form::file('photo',['id'=>'thumbnail']) !!}
