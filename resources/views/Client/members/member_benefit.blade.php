		...
		<div class="index-home">
			...
			<center>
				<div class="padding-bottom-lg-extra wow fadeInLeft">
					<div class="title-page">MEMBER BENEFITS</div>
			...
			<div class="row wow fadeInLeft">
				<div class="pull-right">
					<div class="col-sm-12">
						<a target="_blank" href="{{url('images/upload/members/TBCC_Regulation_and_Members_Benefit_2016.pdf')}}" class="btn btn-success"><i class="fa fa-wa fa-download"></i> DOWNLOAD</a></div>
					</div>
				<div class="clearfix"></div>
				<!-- <center>Member Benefit</center> -->
				<div align="center" style="position:relative;z-index:1;"><a href="{{url('images/upload/members/TBCC_Regulation_and_Members_Benefit_2016.pdf')}}" class="embed"></a></div>
			</div>
