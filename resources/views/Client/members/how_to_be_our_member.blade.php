		...
		<div class="index-home">
			...
			<div class="row wow fadeInLeft">
				<div class="pull-right">
					<div class="col-sm-12">
						<a target="_blank" href="{{url('images/upload/members/TBCC_Membership_Application_Form_2016.pdf')}}" class="btn btn-success"><i class="fa fa-wa fa-download"></i> DOWNLOAD</a></div>
					</div>
				<div class="clearfix"></div>
				<!-- <center>Member Benefit</center> -->
				<div align="center" style="position:relative;z-index:1;"><a href="{{url('images/upload/members/TBCC_Membership_Application_Form_2016.pdf')}}" class="embed"></a></div>
			</div>
