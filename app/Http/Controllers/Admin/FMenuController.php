...
class FMenuController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($allfmenu as $menu){
            ...
            $menu_description = $this->getFmenuDescription('description',$id,CONFIG_LANGUAGE);
            //dd($menu_name);
            $data[] = array(
                'id'=>$menu->id,
                'menu_link'=>$menu_link,
                ...
                'menu_description' => $parent_name.$menu_description,
    ...
    public function store(FMenuRequest $request)
    {
        ...
        for($i=0;$i<$langLen;$i++){
            ...
            $descriptoin = $input['descriptoin_'.$language_id];
    ...
    public function edit($id)
    {
        ...
        foreach ($languages as $lang) {            
            ...
            $menu_description = $this->getFmenuDescription('description',$id,$language_id);
